...
// }
// const courseContent = getFileContent("test/resources/archives/courses.zip");
// const roomContent = getFileContent("test/resources/archives/rooms.zip");

export default class Server {
	private readonly port: number;
	private express: Application;
	private server: http.Server | undefined;
	private readonly insightFacade: InsightFacade = new InsightFacade();
	...
	public addDataset = (req: Request, res: Response) => {
		...
		const context = (req.body as Buffer).toString("base64");
		// console.log(context);
	...
	public listDataset = (req: Request, res: Response) => {
		try {
			// const response = this.insightFacade.listDatasets();

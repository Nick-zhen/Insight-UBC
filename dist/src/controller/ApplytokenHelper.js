...
class ApplytokenHelper {
    ...
    static handleAVG(afterHandleGroup, setApplyKey, setApplyField) {
        ...
        for (let keySection of mapKeys) {
            ...
            for (let section of mapVal) {
                if (setApplyField === "avg") {
                    avgNum = decimal_js_1.default.add(avgNum, new decimal_js_1.default(section.avg).toNumber());
                }
                else if (setApplyField === "pass") {
                    avgNum = decimal_js_1.default.add(avgNum, new decimal_js_1.default(section.pass));
                }
                else if (setApplyField === "fail") {
                    avgNum = decimal_js_1.default.add(avgNum, new decimal_js_1.default(section.fail));
                }
                else if (setApplyField === "audit") {
                    avgNum = decimal_js_1.default.add(avgNum, new decimal_js_1.default(section.audit));
                }
                else if (setApplyField === "year") {
                    avgNum = decimal_js_1.default.add(avgNum, new decimal_js_1.default(section.year));
                }
                else if (setApplyField === "lat") {
                    avgNum = decimal_js_1.default.add(avgNum, new decimal_js_1.default(section.lat));
                }
                else if (setApplyField === "lon") {
                    avgNum = decimal_js_1.default.add(avgNum, new decimal_js_1.default(section.lon));
                }
                else if (setApplyField === "seats") {
                    avgNum = decimal_js_1.default.add(avgNum, new decimal_js_1.default(section.seats));
                }
            }
